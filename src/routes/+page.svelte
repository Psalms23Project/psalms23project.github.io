...
<div id="theproject" class="max-w-6xl mx-auto px-4 my-20">
  <div class="max-w-3xl font-charter text-navyblue">
    ...
    <h2 class="text-4xl sm:text-5xl font-hightower mt-4">High-quality recordings of the Psalms read in calm, natural surroundings.</h2>
    ...
    <p class="text-lg mt-4">The Psalms 23 project aims to record high-quality readings of the Psalms in nature with the peaceful atmosphere and sounds of creation. We hope to align the location of each reading with the overall theme and feeling of each Psalm. </p>
    ...
    <ol class="mt-5 border-l-2 border-navyblue">
      <li>
        ...
        <div class="mb-6 ml-4 mt-2">
          ...
          <p class="mb-3">
            Create this website, including the player.
          </p>
        </div>
      </li>
      <li>
        ...
        <div class="mb-6 ml-4 mt-2">
          ...
          <p class="mb-3">
            Record a trial video to see what we need for camera and audio equipment.
          </p>
        </div>
      </li>
      <li>
