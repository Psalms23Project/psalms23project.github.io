    ...
    <div class="flex flex-col px-8 md:px-24 py-36 rounded-2xl bg-gradient-to-r from-black/20 to-transparent">
      ...
      <div class="mt-20">
        ...
        <p class="font-secondary italic text-white/90 text-xl mt-2 max-w-sm leading-6">
          A royal Psalm praising Yahweh as the King
        </p>
        <div class="flex mt-10">
          <a href="/readings/99/" class=" text-navybluedark font-semibold rounded-lg px-5 py-3 bg-white hover:bg-white/80 duration-300">
            Watch Video
          </a>
        </div>
      </div>
