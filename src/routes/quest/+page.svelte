...
<div class="max-w-6xl mx-auto px-4 mt-10 mb-20"> 
  <div class="max-w-3xl text-navyblue">
    <img class="w-auto rounded-2xl" src="/images/covers/psalm-134.jpg" alt=""/>
    <h1 class="text-4xl sm:text-5xl font-serif mt-8">Our Quest for Quiet Locations</h1>
    <h2 class="text-2xl text-navyblue/80 font-serif italic mt-1">A call for locations to film readings of the Psalms in nature.</h2>
    <p class="text-lg mt-6">The Psalms 23 project aims to film high-quality readings of the Psalms in nature, with the peaceful sounds of creation.</p>
    ...
    <p class="text-lg mt-2">Unnatural sounds include: loud road noise, people talking, machinery, dogs barking, electronic buzz, and airplanes. Lawnmowers or vehicles running nearby could also delay or prevent us from recording.</p>
    <p class="text-lg mt-2">Acceptable natural sounds would be: birds, normal insect noise, and farm animals.</p>
    <p class="text-lg mt-2"><b>If you are not sure if your location is quiet enough for what we need, please still feel free to contact us. We have made locations near busy roads work by filming between the traffic before, so we may be able to make your location work too. :)</b></p>
