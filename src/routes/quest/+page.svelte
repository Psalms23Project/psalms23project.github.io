...
<div class="max-w-6xl mx-auto px-4 mt-10 mb-20"> 
  <div class="max-w-3xl text-navyblue">
    ...
    <ul class="list-disc list-inside text-lg mt-2">
      <li>Since this is a low budget project, <b>we cannot afford to pay for our use of your property</b>. That said, we will always treat you and your property with respect. If you'd like to help out or watch as we film the reading(s) you're welcome to.</li>
    ...
    <p class="text-2xl font-semibold tracking-tight mt-8">What locations are we in need of?</p>
    <ul class="list-disc list-inside text-lg mt-2">
      <li><b>Mountain</b> </li>
